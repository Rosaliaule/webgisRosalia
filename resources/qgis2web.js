...
map.getView().fit([-763781.746014, 5064664.809733, -586729.790457, 5208293.073250], map.getSize());
map.getView().setCenter(ol.proj.fromLonLat([-5.94, 41.70]));
